            ...
            <ul class="nav">
                ...
                <li class="dropdown">
					...
					<ul class="dropdown-menu">
						<li><strong style=" margin-left:10px;">Video</strong>
							<ul style="list-style:none; margin:0px;">
								<li><a href="<?php echo $this->Xyz->u( 'videos', 'index' );?>">View All</a></li>
								<?php if( $this->Session->read( 'Auth.User.is_admin' ) ) { ?>
									<li><a href="<?php echo $this->Xyz->u( 'videos', 'upload' );?>">Upload Video</a></li>
								<?php } ?>
							</ul> 
						</li>
					</ul>
